...
type StoreSlowReleaseStream struct {
	...
	Strategy StreamStrategy `protobuf:"bytes,7,opt,name=strategy,proto3" json:"strategy"`
}

func (m *StoreSlowReleaseStream) Reset()         { *m = StoreSlowReleaseStream{} }
func (m *StoreSlowReleaseStream) String() string { return proto.CompactTextString(m) }
func (*StoreSlowReleaseStream) ProtoMessage()    {}
func (*StoreSlowReleaseStream) Descriptor() ([]byte, []int) {
	return fileDescriptor_810ea65d766ca64e, []int{4}
}
func (m *StoreSlowReleaseStream) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StoreSlowReleaseStream) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StoreSlowReleaseStream.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StoreSlowReleaseStream) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StoreSlowReleaseStream.Merge(m, src)
}
func (m *StoreSlowReleaseStream) XXX_Size() int {
	return m.Size()
}
func (m *StoreSlowReleaseStream) XXX_DiscardUnknown() {
	xxx_messageInfo_StoreSlowReleaseStream.DiscardUnknown(m)
}

var xxx_messageInfo_StoreSlowReleaseStream proto.InternalMessageInfo
...
func (*StreamStrategy) Descriptor() ([]byte, []int) {
	return fileDescriptor_810ea65d766ca64e, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*StoreSlowReleaseStream)(nil), "regen.divvy.v1.StoreSlowReleaseStream")
...
var fileDescriptor_810ea65d766ca64e = []byte{
	...
	,
}
...
func (m *StoreSlowReleaseStream) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StoreSlowReleaseStream) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StoreSlowReleaseStream) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StoreSlowReleaseStream) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StoreSlowReleaseStream) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StoreSlowReleaseStream: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StoreSlowReleaseStream: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
